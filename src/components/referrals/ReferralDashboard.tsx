...
import { Users, Gift, Share2, Copy, Mail, ExternalLink } from 'lucide-react';
import { toast } from '@/hooks/use-toast';

const ReferralDashboard: React.FC = () => {
  const { stats, referrals, loading, sendInvitations, getReferralUrl } = useReferrals();
    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold font-mono">{stats?.referral_code || 'Loading...'}</div>
            <Button 
              variant="outline" 
              size="sm" 
