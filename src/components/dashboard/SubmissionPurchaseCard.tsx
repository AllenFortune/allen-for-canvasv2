...
const SubmissionPurchaseCard: React.FC = () => {
  const { usage, loading, purchaseAdditionalSubmissions } = useSubscription();
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Progress 
              ...
              className={`w-full h-2 ${isNearLimit ? 'bg-orange-100' : 'bg-gray-100'}`}
            />
            <div className="flex justify-between text-xs text-gray-500 mt-1">
              <span>Plan: {usage.limit}</span>
              {usage.purchased_submissions > 0 && (
          ...
          <div className="space-y-3">
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
              ...
              <Button 
                onClick={purchaseAdditionalSubmissions}
