...
const FallPromotionBanner = () => {
  ...
  return <div className="fixed top-16 left-0 right-0 z-60 overflow-hidden bg-gradient-to-r from-orange-500 via-amber-500 to-orange-600 text-white">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
              <div>
                <h3 className="text-lg font-bold">Spring Special!</h3>
          ...
          <Button onClick={handleDismiss} variant="ghost" size="sm" className="text-white hover:bg-white/20 flex-shrink-0" aria-label="Dismiss promotion banner">
            <X className="h-4 w-4" />
          </Button>
        </div>
      </div>
